...
// import { formatAddress } from "../../utils/units";
  ...
  return (
    <>
      ...
      <section className="how_section layout_padding">
        ...
        <div className="how_container">
          <div className="box">
            ...
            <div className="detail-box">
              <h5>Innovators and investors</h5>
              <p>
                Innovators purchase plastic waste from collectors and recycle it
                into valuable products for the consumers. Investors can invest
                in the recycling process and earn a return on their investment.
              </p>
            </div>
          </div>
          <div className="box">
            ...
            <div className="detail-box">
              <h5>Exchanges</h5>
              <p>Customers can exchange tokens for ETH</p>
            </div>
          </div>
          <div className="box">
            <div className="img-box">
          ...
          <div className="box">
            ...
            <div className="detail-box">
              <h5>Payments</h5>
              <p>
                Customers can acess the liquidity pool to exchange tokens for
                ETH
              </p>
            </div>
          </div>
      ...
      <section className="about_section layout_padding-bottom">
        <div className="container">
          <div className="heading_container">
            <h2>About PolyCoin</h2>
          </div>
          <div className="box">
            <div className="img-box">
              <img src="images/etth.png" alt="" />
            </div>
            <div className="detail-box">
              <p>
                We are a decentralized platform that enables the recycling of
                plastic waste into tokens. Our Token is backed by the value of
                recycled plastic waste and can be exchanged for ETH.
              </p>
              <div className="btn-box">
                <a href="">Read More</a>
              </div>
  ...
  <div class="col-md-6">
    <div class="img-box">
      ...
      <section className="auto_section layout_padding">
        <div className="container">
          <div className="heading_container">
            <h2>Join PolyCoin Now</h2>
          </div>
          <div className="box">
            <div className="img-box">
              <img src="images/ethstack.jpg" alt="" />
            </div>
            <div className="detail-box">
              <p>
                Join PolyCoin now and start earning rewards for recycling
                plastic waste.
              </p>
              <div className="btn-box">
    ...
    <div class="info_links">
      ...
      <section className="container-fluid footer_section">
        <p>
          ...
          <a href="https://html.design/">EcoVanguards</a>
        </p>
      </section>
    </>
  );
